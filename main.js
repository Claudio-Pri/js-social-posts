...
for (let i = 0; i < posts.length; i++) {
    //prova stampa contenuto oggetto
    console.log("id", posts[i].id);
    console.log("content", posts[i].content);
    console.log("media", posts[i].media);
    console.log("author", posts[i].author);
    console.log("name", posts[i].author.name);
    console.log("profile image", posts[i].author.image);
    console.log("likes", posts[i].likes);
    console.log("created", posts[i].created);
    //provo ad aggiungere con template literal
